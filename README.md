...
2. [Pandoc](http://pandoc.org/) версии 3.1.12 или выше.
3. pandoc-crossref — необходимый фильтр. Дистрибутив можно
...
в одну из директорий, указанных в переменной окружения `PATH`,
например в ту же директорию, в которой находится установленный
`pandoc.exe` (обычно `C:\Program Files\Pandoc`); инсталлятор
